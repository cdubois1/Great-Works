...
//=========================================================================================
/*
 *This program performs a full DES Encryption and Decryption of a given phrase.
 *Unfortunately the file was somewhat corrupted. I had to reformat the whole thing 
 *and I believe there are some errors within it now as I was unsure where each semicolon and bracket was
 *supposed to be exactly. Still, I doubt anyone cares to see the encryption itself, so I leave this
 *as a proof of concept that I can write code to perform an ungodly amount of moving 1's and 0's.
*/
using namespace std;
	int key[64]={
		0,0,0,1,0,0,1,1,
